...
import 'package:spend_flow/screen/setting/currency/currency_view.dart';
import 'package:spend_flow/screen/setting/font/font_view.dart';
import 'package:spend_flow/screen/setting/language/language_view.dart';
    ...
    return Column(
      ...
      children: [
        ...
        SettingItem(
          ...
          iconBgColor: Color.fromARGB(255, 211, 187, 0),
          onTap: () {
            Navigator.push(
              context,
