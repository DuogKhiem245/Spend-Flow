These terms and conditions apply to the **Spend Flow** app (hereby referred to as "Application") for mobile devices that was created by **24DK Labs** (hereby referred to as "Service Provider") as a Free service.
...
## 3. Data Security & Device Integrity
...
## 5. Connectivity & Responsibilities
...
The Service Provider may wish to update the application at some point. The application is currently available as per the requirements for the operating system may change, and you will need to download the updates if you want to continue using the application. The Service Provider does not guarantee that it will always update the application so that it is relevant to you and/or compatible with the particular operating system version installed on your device. 
...
## 10. Account Deletion
You can request the deletion of your account and all associated personal data at any time. To exercise this right, please contact the Service Provider at **khiemduong.dev@gmail.com** with the subject line "Account Deletion Request" or contact us via the in-app support section. After receiving your request, we will verify your identity and permanently delete your information, including email, profile, and all stored spending data, within 3 to 7 days. Please note that this action is irreversible and deleted data cannot be recovered.

## 11. Contact Us
If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider directly via the **Information & Support** section in the application's **Settings**, or by emailing us at **khiemduong.dev@gmail.com**.