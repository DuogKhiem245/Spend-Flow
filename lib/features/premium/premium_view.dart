...
class PremiumView extends StatelessWidget {
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                  ...
                  children: [
                    Expanded(
                      child: SingleChildScrollView(
                        ...
                        child: _buildMainContent(l10n, context),
                      ),
                    ),
                ...
                if (!viewModel.isLoading) _buildCloseButton(context),

                if (!viewModel.isLoading) _buildRestoreButton(viewModel, l10n),
              ],
            ),
          ),
        );
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: viewModel.isLoading
                ? null
                : () async {
                    await viewModel.debugFakePurchase(shouldNotify: false);
  ...
  Widget _buildMainContent(AppLocalizations l10n, BuildContext context) {
    return Column(
      children: [
        Stack(
